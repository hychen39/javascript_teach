...
Continue from the above example with the following extra requirements:

- Apply the inline style to the texts of the selected favorite colors. 
  - Change the text of the selected checkbox's label to the color it represents. 
  - e.g. if the user selects the "Red" checkbox, the label text should be in red color.

<img src="img/24-08-23-20-17-33.png" alt="Example 9-6" width="400"/>

---

The logical steps for the solution:
